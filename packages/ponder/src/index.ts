...
// ============ PositionManager REMOVED ============
// PositionManager Transfer events index ALL Uniswap V4 positions on Base (not just ours).
// This was consuming 90%+ of RPC calls (89K+ eth_getLogs).
// Position ownership is now handled by:
//   - V4Utils:PositionMinted handler (our minted positions)
//   - V4AutoRange:Rebalanced handler (rebalanced positions)
//   - Backend's position-indexer.ts (Transfer event tracking via direct RPC)
//   - Graph subgraph (general pool/position data)
